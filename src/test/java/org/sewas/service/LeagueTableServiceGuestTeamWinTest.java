...
public class LeagueTableServiceGuestTeamWinTest {
    ...
    public void shouldCalculatePoints() {
        // then
        assertThat(this.tp1.getPoints()).isEqualTo(0);
        assertThat(this.tp2.getPoints()).isEqualTo(3);
    }
    ...
    public void shouldCalculateGoalDifference() {
        // then
        assertThat(tp1.getGoalsFor()).isEqualTo(0);
        assertThat(tp1.getGoalsAgainst()).isEqualTo(1);

        assertThat(tp2.getGoalsFor()).isEqualTo(1);
        assertThat(tp2.getGoalsAgainst()).isEqualTo(0);
    }
}
